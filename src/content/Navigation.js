...
export default {
    [LANGUAGE.EN]: {
        ...
        scheduleBrazil: () => <span>Schedule</span>,
        travel: () => <span>Travel</span>,
        travelBrazil: () => <span>Travel</span>,
        thingsToDo: () => <span>Things to Do</span>,
        faq: () => <span>FAQs</span>,
        registry: () => <span>Registry</span>,
        rsvp: () => <span>RSVP</span>,
        rsvpBrazil: () => <span>RSVP</span>,
    ...
    [LANGUAGE.PT]: {
        ...
        scheduleBrazil: () => <span>Programa&ccedil;&atilde;o</span>,
        travel: () => <span>Como Chegar</span>,
        travelBrazil: () => <span>Como Chegar</span>,
